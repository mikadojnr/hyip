    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
      <div class="modal-content">
        <div class="modal-body">
          <img src="{{ asset('proofs/'.$transaction->proof) }}" class="img-fluid" alt="Payment Proof">
        </div>
      </div>
    </div>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 ">
                            ...
                            @if( $transaction->proof )
                                <div>
                                    <img src="{{ asset('proofs/'.$transaction->proof) }}" alt="Payment proof" class="img-thumbnail" data-toggle="modal" data-target="#imageModal" width="150"/>
                                </div>
